...
parser.add_argument('--exp', type=str,
                    default='Synapse/Fully_Supervised1', help='experiment_name')
...
def patients_to_slices(dataset, patiens_num):
    ...
    if "ACDC" in dataset:
        ...
        ref_dict = {"2": 248, "4": 560, "6": 851,
                    "12": 179, "16": 256, "21": 312, "30": 2211}
    else:
        print("Error")
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume(
                        sampled_batch["image"], sampled_batch["label"], model, classes=num_classes, model_type=args.model,patch_size=args.patch_size)
