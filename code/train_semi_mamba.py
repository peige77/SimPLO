...
from networks.vision_mamba_origin import MambaUnet as ViM_seg
...
parser.add_argument('--exp', type=str,
                    default='Prostate/Semi_Mamba_UNet', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='mambaunet_origin', help='model_name')
